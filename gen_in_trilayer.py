...
for line in in_file:
    line=line.replace('NSW    =    200 ','NSW    = 0')
    line=line.replace('IBRION =    2 ','IBRION =  -1')
    line=line.replace('MAGMOM = 3*0 6*0',  'MAGMOM = 0 0 2 0 0 -2 18*0')
...
for k in xc_list :
    ...
    for i in atoms13:
        ...
        count +=1
    print(atoms13.get_positions(), Delta, h)
    atoms_shifted=atoms11+atoms12+atoms13
