...
atoms44=atoms22.copy()
atoms44.center(about=atoms22.positions[0])
count=0
for i in atoms44:
    atoms44.positions[count][2] += 2*h
    count +=1
print(atoms44.get_positions(), Delta, h)
atoms_shifted=atoms11+atoms22+atoms33+atoms44
cell1Z[2] +=2.5*h
